...
- Recompiled plugin with Go version `1.24`. ([#61](https://github.com/turbot/steampipe-plugin-chaosdynamic/pull/61))
- Recompiled plugin with [steampipe-plugin-sdk v5.13.1](https://github.com/turbot/steampipe-plugin-sdk/blob/develop/CHANGELOG.md#v5131-2025-09-25) that addresses critical and high vulnerabilities in dependent packages. ([#65](https://github.com/turbot/steampipe-plugin-chaosdynamic/pull/65))
